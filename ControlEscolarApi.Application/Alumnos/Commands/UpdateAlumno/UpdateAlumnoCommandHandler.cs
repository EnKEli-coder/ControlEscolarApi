...
public class UpdateAlumnoCommandHandler(
  IGenericRepository<Alumno> alumnoRepository ) : IRequestHandler<UpdateAlumnoCommand, ErrorOr<Alumno>>
{

  IGenericRepository<Alumno> _alumnoRepository = alumnoRepository;
  public async Task<ErrorOr<Alumno>> Handle(UpdateAlumnoCommand request, CancellationToken cancellationToken)
  {
